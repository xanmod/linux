/*
 * Completely Fair Scheduling by (CFS) Class (SCHED_NORMAL/SCHED_BATCH)
 *
 ...
 * (XanMod default: 2ms * (1 + ilog(ncpus)), units: nanoseconds)
 *
 ...
 * (XanMod default: 1ms * (1 + ilog(ncpus)), units: nanoseconds)
 */
 ...
 *
 * XanMod default: 2 msec, units: microseconds
  */
